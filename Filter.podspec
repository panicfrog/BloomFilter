#
#  Be sure to run `pod spec lint Filter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "yongping"
  # spec.authors            = { "yongping" => "burnedfrog@163.com" }
  # spec.social_media_url   = "https://twitter.com/yongping"
  ...
  spec.xcconfig = { 'SWIFT_INCLUDE_PATHS' => '$(SRCROOT)/Filter/Sources/Cmurmur3/include/**' }
  spec.preserve_paths = 'Sources/Cmurmur3/module.modulemap'
